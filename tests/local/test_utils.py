...
class Generic(TestCase):
    ...
    def test_get_subtitles_temp_file(self):
        ...
        fname = utils.create_subtitles_temp_file()
        ...
        # specify language
        fname = utils.create_subtitles_temp_file('en')
...
- Hello <b>world</b>"""
    ...
    def test_convert_whole_file(self):
        for subtitle in (
                'vtt/subtitles-trailer-la_grande_bellezza.vtt',
                'vtt/subtitles-you_were_never_really_here.vtt',
                'vtt/subtitles-norwegian_wood.vtt',
                'vtt/subtitles-un_amour_de_jeunesse.vtt',
                'vtt/subtitles-woman_at_war.vtt'):
...
class RemoveMarkdown(TestCase):
    ...
    def test_remove_with_escapes(self):
        ...
        result = utils.remove_markdown('some \__italics_\_ in a string')
